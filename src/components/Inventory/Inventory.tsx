    ...
    const handleClickOpen = () => {
        ...
        const columns = React.useMemo<any>(
            () => [
                ...
                { field: 'status',flex:0.1, headerName: 'ESTATUS', type: 'string', headerClassName: 'data-header' },
                { field: 'met2',flex:0.07, headerName: 'MET 2', type: 'string', headerClassName: 'data-header' },
                { field: 'unitArea', headerName: 'UNIT AREA (SQ FT)', type: 'string', headerClassName: 'data-header' },
                { field: 'priceUnit', headerName: 'PRECIO POR UNIDAD', type: 'string', headerClassName: 'data-header' },
                { field: 'priceList', headerName: 'PRECIO LISTA', type: 'string', headerClassName: 'data-header' },
                { field: 'rooms', headerName: 'HABITACIONES', type: 'string', headerClassName: 'data-header' },
                { field: 'view', headerName: 'VISTA', type: 'string', headerClassName: 'data-header' },
                { field: 'signatureDate', headerName: 'FIRMA DE CONTRATO', type: 'string', headerClassName: 'data-header' },
    ...
    <Stack paddingTop={{ xs: "130px", sm: '130px', md: '80px',xl:'80px' }} >                
                ...
                marginTop: '20px',marginBottom: '20px',marginRight: '20px' }}>
                    <Box>
                        ...
                        {<AddIcon style={{fontSize:'20px'}} />}{t('Agregar Inventario')}
                        </ButtonBase>
                    </Box>
                </Stack>
                    <Box sx={{
