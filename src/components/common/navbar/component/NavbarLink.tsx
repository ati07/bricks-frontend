...
export default function NavbarLink(props: any) {
	...
	return (
		<Flex
			...
			<Select borderColor='transparent' margin={'5px'} variant='filled' placeholder='Select option' value={lang} size='sm' onChange={handleChangeLangauge}>
				{lngs.map((i: any, j: number) => <option key={j} value={i.code} >{i.native}</option>)}
			</Select>
