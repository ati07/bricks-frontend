...
import './ProjectPaymentReport.css'
import Footer from '../footer/Footer';
import { StripedDataGrid } from '../client/Client';
import CollectionReportForm from './ProjectPaymentReportForm';
...
function ProjectPaymentReport() {
   ...
   const handleClickOpen = () => {
       ...
       const columns = React.useMemo<any>(
           () => [
            {
              field: 'week',flex:0.1, headerName: 'SEMANA', type: 'string', width: 150, headerClassName: 'data-header',
              ...
              // renderCell: (props: any) => <div>{props.value.split('T')[0]}</div>
               ...
               {
                   field: 'date',flex:0.1, headerName: 'FECHA', type: 'string', width: 150, headerClassName: 'data-header',
                   renderHeader: (params: any) => (<strong>
                       {params.colDef.headerName}
                   </strong>),
                   // renderCell: (props: any) => <div>{props.value.split('T')[0]}</div>
               },
               { field: 'contractor',flex:0.07, headerName: 'PROVEEDOR/CONTRATISTA', type: 'string', headerClassName: 'data-header' },
               { field: 'requestedBy',flex:0.1, headerName: 'SOLICITADO POR', type: 'string', headerClassName: 'data-header' },
               
               { field: 'total',flex:0.1, headerName: 'TOTAL', type: 'string', headerClassName: 'data-header' },
               { field: 'projectCategory',flex:0.07, headerName: 'CATEGORIA DE PROYETO', type: 'string', headerClassName: 'data-header' },
               { field: 'invoiceDescription',flex:0.07, headerName: 'DESCIPCIÓN DE LA FACTURA', type: 'string', headerClassName: 'data-header' },
               { field: 'code',flex:0.07, headerName: 'CODIGO', type: 'string', headerClassName: 'data-header' },
               { field: 'subPhase',flex:0.07, headerName: 'SUB-FASE', type: 'string', headerClassName: 'data-header' },
               { field: 'comment',flex:0.07, headerName: 'COMENTARIO', type: 'string', headerClassName: 'data-header' },
               { field: 'orderNo',flex:0.07, headerName: 'NO. DE PEDIDO', type: 'string', headerClassName: 'data-header' },
    ...
    <Stack paddingTop={{ xs: "130px", sm: '130px', md: '80px',xl:'80px' }} >                
                ...
                marginTop: '20px',marginBottom: '20px',marginRight: '20px' }}>
                    <Box>
                        ...
                        {<AddIcon style={{fontSize:'20px'}} />}{t('Agregar Report de Pagos')}
                        </ButtonBase>
                    </Box>
                </Stack>
                    <Box sx={{
