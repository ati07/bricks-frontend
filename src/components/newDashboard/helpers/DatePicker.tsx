...
export const dateToHeading = (date1: any, date2: any) => {
    ...
    return <Box style={{ display: 'flex',justifyContent: 'center',alignItems: 'center'}} gap={1}>

        <Typography style={{ fontSize:'12px'}}>{dateFormate(date1,'DD/MM/YYYY')}</Typography>
        <Typography> - </Typography>
        <Typography style={{ fontSize:'12px'}}>{dateFormate(date2,'DD/MM/YYYY')}</Typography>
    </Box>
