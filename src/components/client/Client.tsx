...
import MerchantForm from './ClientForm';
...
export function CustomToolbar() {
    return (
        <Box style={{ margin: '10px' }}>
            <GridToolbarContainer>
                {/* <GridToolbarColumnsButton /> */}
                {/* <GridToolbarFilterButton className='btn_filter' sx={{ color: 'white',margin:'5px' }} /> */}
                {/* <GridToolbarDensitySelector /> */}
...
//                     <GridToolbarExport className='btn_filter' sx={{ color: 'white', margin: '5px' }} ref={setFilterButtonEl} />
...
function Client() {
    ...
    const columns = React.useMemo<any>(
        () => [
            ...
            // { field: 'company',flex:0.17, headerName: 'Company', type: 'string', width: 250, headerClassName: 'data-header' },
            // {
            //     field: 'merchant',flex:0.17, headerName: 'Merchant', type: 'string', width: 200, cellClassName: 'super-app-theme--cell', headerAlign: 'center', headerClassName: 'data-header',
            //     renderCell: (props: any) => {
            //         // console.log("propsmerchantRow",props) 
            //         return <HtmlTooltip style={{background:'#fff'}} title={
            //               <div style={{paddingRight:'2px',display:'flex',flexDirection:'column',justifyContent:'center'}}>
            //                    {props?.value ? props?.value?.map((i: any, j: any) => <li key={j}>{i}</li>) : 'loading..'}
            //               </div>
            //             } placement="right">

            //             <span>
            //                 <RemoveRedEyeOutlinedIcon sx={{width:'12px'}}/>
            //             </span>
            //         </HtmlTooltip>
        ...
        <Stack paddingTop={{ xs: "130px", sm: '130px', md: '80px',xl:'80px' }} >                
                ...
                marginTop: '20px',marginBottom: '20px',marginRight: '20px' }}>
                    <Box>
                        ...
                        {<AddIcon style={{fontSize:'20px'}} />}{t('Agregar Contratista')}
                        </ButtonBase>
                    </Box>
                </Stack>
                    <Box sx={{
